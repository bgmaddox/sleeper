...
| 11 | Pick 'Em page (port game to webapp, Survivor-tab pattern) | deferred — decided 2026-07-15: Pick 'Em IS still played and will get its own page/tab on the site; pulled out of Session 8 scope so S8 stays focused on notebook retirement. Do not discard the notebook's PickEm logic when archiving in S8 |
